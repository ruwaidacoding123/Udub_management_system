    ...
    <div class="modal-content">
        ...
        <form id="editForm" method="POST" action="edit_employee.php">
            ...
            <div class="form-group">
                ...
                <input type="text" id="firstName" name="firstName" required pattern="[A-Za-z\s]+" title="Please enter only letters.">
            </div>
            <div class="form-group">
                <label for="lastName">Last Name</label>
                <input type="text" id="lastName" name="lastName" required pattern="[A-Za-z\s]+" title="Please enter only letters.">
            </div>
            <div class="form-group">
                <label for="phoneNumber">Phone Number</label>
                <input type="tel" id="phoneNumber" name="phoneNumber" required pattern="\d{10,15}" title="Please enter a valid phone number.">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" id="salary" name="salary" required min="0" step="0.01" title="Please enter a valid amount.">
            </div>
            <div class="form-group">
...
function openEditModal(employee) {
    ...
    document.getElementById('address').value = employee.Address; // Set address value
    document.getElementById('dates').value = employee.Date;
    document.getElementById('salary').value = employee.Salary;
    document.getElementById('role').value = employee.Role;

    var currentDate = new Date().toISOString().split('T')[0];
    document.getElementById('dates').setAttribute('min', currentDate);
    document.getElementById('dates').setAttribute('max', currentDate);
