    ...
    <div class="modal-content">
        ...
        <form id="editForm" method="POST" action="edit_assign.php">
            ...
            <div class="form-group">
                ...
                <input type="text" id="client_name" name="client_name" required pattern="[A-Za-z\s]+" title="Please enter only letters and spaces.">
            </div>
            <div class="form-group">
                <label for="phone_number">Phone Number</label>
                <input type="tel" id="phone_number" name="phone_number" required pattern="\d{10,15}" title="Please enter a valid phone number (10-15 digits).">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" id="deposit_amount" name="deposit_amount" required min="0" step="0.01" title="Please enter a valid amount.">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" id="amount" name="amount" required min="0" step="0.01" title="Please enter a valid amount.">
            </div>
            <div class="form-group">
