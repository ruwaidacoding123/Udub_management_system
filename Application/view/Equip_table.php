...
<body>
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        $date_acquired = date("d/m/Y", strtotime($row['date_acquired']));
                        echo "<tr>
                            <td>{$row['name']}</td>
                            <td>{$row['model']}</td>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" action="edit_equipment.php">
                <input type="hidden" id="edit_id" name="id">
                <div class="form-group">
                    <label for="edit_name">Name</label>
                    <input type="text" id="edit_name" name="name" required pattern="[A-Za-z\s]+" title="Please enter only letters and spaces.">
                </div>
                <div class="form-group">
                    <label for="edit_model">Model</label>
                    <input type="text" id="edit_model" name="model" required pattern="[A-Za-z0-9\s-]+" title="Please enter only letters, numbers, spaces, and hyphens.">
                </div>
                <div class="form-group">
                    <label for="edit_manufacturer">Manufacturer</label>
                    <input type="text" id="edit_manufacturer" name="manufacturer" required pattern="[A-Za-z\s]+" title="Please enter only letters and spaces.">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="edit_price" name="price" required min="0" step="0.01" title="Please enter a valid amount.">
                </div>
                <div class="form-group">
