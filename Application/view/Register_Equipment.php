...
<body>
    <div class="container">
        ...
        <form action="" method="post">
            ...
            <input type="text" id="model" name="model" required pattern="[A-Za-z0-9\s-]+" title="Please enter only letters, numbers, spaces, and hyphens.">

            <label for="manufacturer">Manufacturer:</label>
            <input type="text" id="manufacturer" name="manufacturer" required pattern="[A-Za-z\s]+" title="Please enter only letters and spaces.">
